...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&pause=1000&color=39FF14&background=00000000&center=true&vCenter=true&width=500&height=50&lines=Class+6+Student+Developer;Building+the+Basic+ICTL+Language;Crafting+Andex+OS+on+Scratch;Co-Developing+AstralyxPvP+Site" alt="Typing Effect" />
</a>
</p>
<p align="center">
 ...
 * **AstralyxPvP Server Website** - Co-developed a responsive community website hub for a custom Minecraft gaming server network. 🎮
#### 💻 Core Development
 * **Basic ICTL Programming Language (WIP)** - A custom interpreted/compiled concept language built from scratch.
 * **Andex OS** - An interactive operating system simulation engine designed inside Scratch.
#### 🐍 Python Utilities
 * **Str-QR-Code-Gen_ic3** - A clean string-to-QR code generation utility.
 * **PyCalc** - A standalone Python calculation engine.
 * **BMI App** - Health index calculator backend implementation.
#### 🕹️ Web Apps & Visuals
 * **Tic-Tac-Toe & Web Projects** - Clean frontend JavaScript deployment optimized for performance on Cloudflare.
 * **Random Particle Graphics** - Canvas rendering experiments.
### 📊 GitHub Stats
<p align="center">
